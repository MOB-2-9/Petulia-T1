...
enum OrgSectionKind: String {
  case recent = "Recent"
  case favorites = "Favorites"
}


struct OrgSectionView: View {
  var kind: OrgSectionKind
...
private extension OrgSectionView {
  ...
  func titleBar() -> some View {
    HStack {
      Text(title.capitalized)
        .font(.title)
      Spacer()
      NavigationLink("See All", destination: OrgPetListView(
